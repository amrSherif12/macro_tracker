...
class ConstColors {
  static Color secOff = Colors.green[400]!;
  static Color secMidOff = Colors.green[500]!;
  static Color sec = Colors.green[700]!;
  static Color secMid = Colors.green[800]!;
  static Color secDark = Colors.green[900]!;

  static Color exeOff = Colors.blue[300]!;
  static Color exeMidOff = Colors.blue[400]!;
  static Color exe = Colors.blue[600]!;
